 ...
 * 2. Compile: 
 *      `javac -cp async-anderson-algo/junit-platform-console-standalone-1.9.3.jar async-anderson-algo/*.java`
 * 3. Run: 
 *      `java -jar async-anderson-algo/junit-platform-console-standalone-1.9.3.jar --class-path async-anderson-algo --scan-classpath`
 * 4. Clean: 
